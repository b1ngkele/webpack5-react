 ...
 * @LastEditors: y2029
 * @LastEditTime: 2021-08-13 11:23:59
 */
...
// 创建store实例 第一个参数是reducer集合（reducers），
// 第二个参数初始化的store（initialState），第三个参数是applyMiddleware函数，
// 来使用中间件 ，因为只在reducer里面初始化了值，所以这里并没有传入初始化store的值
